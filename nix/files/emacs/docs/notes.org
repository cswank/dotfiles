...
*** reference 2nd table
| service            | estimate | why                                                                                                                    |
|--------------------+----------+------------------------------------------------------------------------------------------------------------------------|
| tiles              |    40000 | when viewing shipment report that has map (we had 19k shipment page view last year so I just doubled that in optimism) |
| address suggestion |    10000 | once per facility creation                                                                                             |
| geo                |    10000 | once per facility creation                                                                                             |
| reverse geo        |   100000 | mobile uploads                                                                                                         |
